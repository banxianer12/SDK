...
#define SPI_CDR2_MAX_FRQUENCY 50000000
...
static void spi_set_clk(u32 spi_clk, u32 ahb_clk, void __iomem *base_addr, u32 cdr)
{
	...
	/*
	 * If the SPI clock is larger than 50MHz,
	 * CDR1 needs to be used, otherwise it cannot be divided
	 */
	if(spi_clk > SPI_CDR2_MAX_FRQUENCY)
		cdr = 0;
