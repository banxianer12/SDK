...
void iTE6805_Init_fsm(void)
{
	...
	/*********************************wanpeng add******************************/
	if (mhl_client == NULL && this_adap != NULL) {
		mhl_client = i2c_new_device(this_adap, &it6807_mhl_info);
		if (mhl_client) {
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	if (cec_client == NULL && this_adap != NULL) {
		cec_client = i2c_new_device(this_adap, &it6807_cec_info);
		if (cec_client) {
	...
	/*********************************wanpeng add******************************/
	if (edid_client == NULL && this_adap != NULL) {
		edid_client = i2c_new_device(this_adap, &it6807_edid_info);
		if (edid_client) {
