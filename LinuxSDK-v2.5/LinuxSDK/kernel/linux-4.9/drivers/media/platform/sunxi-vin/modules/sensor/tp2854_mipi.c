/*
 * A V4L2 driver for tp2854 cameras.
 *
...
#define DOUBLE_CLK_POL		V4L2_MBUS_PCLK_SAMPLE_FALLING
...
#define SENSOR_NAME	"tp2854_mipi"
...
static int sensor_detect(struct v4l2_subdev *sd)
{
	...
	sensor_id = (rdval << 8) & 0xff00;
	ret = sensor_read(sd, 0xff, &rdval);
	sensor_id |= rdval & 0xff;
...
static struct sensor_win_size sensor_win_sizes[] = {
	...
	.voffset = 0,
	.fps_fixed = 25,
	.regs = sensor_720p25_regs,
	.regs_size = ARRAY_SIZE(sensor_720p25_regs),
	.set_size = NULL,
	},
