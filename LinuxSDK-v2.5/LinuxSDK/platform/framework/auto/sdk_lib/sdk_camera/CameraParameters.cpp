...
// Parameter keys to communicate between camera application and driver.
	...
	const char CameraParameters::KEY_SUPPORTED_JPEG_THUMBNAIL_SIZES[] =
	...
	const char CameraParameters::KEY_AUTO_EXPOSURE_LOCK_SUPPORTED[] =
	...
	const char CameraParameters::KEY_VIDEO_STABILIZATION_SUPPORTED[] =
...
// Parse string like "640x480" or "10000,20000"
	...
	const char *CameraParameters::getPictureFormat() const {
		...
		char buffer[SIZE];
		String8 result;
		 snprintf(buffer, 255, "CameraParameters::dump: mMap.size = %ld\n", mMap.size());
