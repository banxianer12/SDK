...
CShareMem::CShareMem(int key, int size,int flag)
{
...
CShareMem::~CShareMem()
{
	...
	{
		destroyMemory();				       //将会调用detach方法来脱离共享内存
	}
}
/*
* 函数功能：共享内存创建操作方法
...
* 返 回 值：成功创建返回true，否则返回false
*/
bool CShareMem::attachMemory(char*& pmemoryAddr)
{
...
* 返 回 值：成功创建返回true，否则返回false
*/
bool CShareMem::detachMemory(char* pmemoryAddr)
{
