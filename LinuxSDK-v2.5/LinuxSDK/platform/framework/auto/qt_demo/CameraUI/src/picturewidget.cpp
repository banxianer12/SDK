    ...
    ui(new Ui::pictureWidget)
{
    ...
    connect(this,SIGNAL(main_desktop_disvisible()),g_pStaticMaindesktop,SLOT(on_main_desktop_disvisible()));

    connect(g_MidWindow,SIGNAL(usb_insert()),this,SLOT(on_usb_mount()));
    connect(g_MidWindow,SIGNAL(usb_delete()),this,SLOT(on_usb_umount()));
...
void pictureWidget::show_big_picture(QModelIndex pos)
{
    ...
    if(pic.isNull())
    {
        ...
        g_pStaticMaindesktop->on_main_desktop_disvisible();
