...
static const argument_t ArgumentMapping[] =
{
    ...
    { "-if",  "--input_format",  INPUT_FORMAT,
        "0:VENC_PIXEL_YUV420SP, 1:VENC_PIXEL_YVU420SP, 2:VENC_PIXEL_YUV420P, 3:VENC_PIXEL_YVU420P" },
...
void ParseArgument(encode_param_t *encode_param, char *argument, char *value)
{
    ...
    switch(arg)
    {
        ...
        case ENCODE_FRAME_NUM:
            ...
            break;
        case INPUT_FORMAT:
            sscanf(value, "%32u", &encode_param->input_Format);
            printf("input_format:%u 0:VENC_PIXEL_YUV420SP, 1:VENC_PIXEL_YVU420SP, 2:VENC_PIXEL_YUV420P, 3:VENC_PIXEL_YVU420P\n", encode_param->input_Format);
            break;
        case ENCODE_FORMAT:
...
int initH264Func(h264_func_t *h264_func, encode_param_t *encode_param)
{
    ...
    h264_func->h264Param.sRcParam.sVbrParam.uRatioChangeQp   = 85;
    h264_func->h264Param.sRcParam.sVbrParam.nQuality    = 5;
...
void* ChannelThread(void* param)
{
    ...
    for(m=0; m<cycle_num; m++)
    {
        ...
        encode_param.input_Format = VENC_PIXEL_YUV420P;
