                                          ...
                                          OMX_PARAM_PORTDEFINITIONTYPE *value)
{
    ...
    if(value->nBufferCountActual != mPort->m_BufferCntActual)
    {
        ...
        OMX_U32 buffArrSize = \
               sizeof(OMX_BUFFERHEADERTYPE) * value->nBufferCountActual;
        mPort->m_sBufList.pBufArr = (OMX_BUFFERHEADERTYPE*)malloc(buffArrSize);

        OMX_U32 bufHdrListSize = \
               sizeof(OMX_BUFFERHEADERTYPE*) * value->nBufferCountActual;
        mPort->m_sBufList.pBufHdrList = (OMX_BUFFERHEADERTYPE**)malloc(bufHdrListSize);
