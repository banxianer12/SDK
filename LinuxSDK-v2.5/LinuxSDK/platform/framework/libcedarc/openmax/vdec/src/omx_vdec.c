...
static OMX_ERRORTYPE omxSetRole(AwOmxVdec* impl, const OMX_U8* srcRole)
{
    ...
    if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.mjpeg",
      OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.mjpeg", OMX_MAX_STRINGNAME_SIZE))
        {
    ...
    else if(!strncmp((char*)impl->m_cName,
            "OMX.allwinner.video.decoder.mpeg1", OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.mpeg1", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
        ...
        impl->m_eCompressionFormat      = OMX_VIDEO_CodingMPEG1;
            ...
            "OMX.allwinner.video.decoder.mpeg2", OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
            strncmp((const char*)srcRole,"video_decoder.mpeg2", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
        ...
        "OMX.allwinner.video.decoder.mpeg4", OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.mpeg4", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.msmpeg4v1", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.msmpeg4v2", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.msmpeg4v3", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
         strncmp((const char*)srcRole,"video_decoder.divx4", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.rx", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.avs", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.divx",
           OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.divx", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.xvid",
             OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.xvid", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.h263",
            OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.h263", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.s263",
             OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.s263", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.rxg2",
             OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.rxg2", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.wmv1",
            OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.wmv1", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.wmv2",
            OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
         strncmp((const char*)srcRole,"video_decoder.wmv2", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.vc1",
            OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.vc1", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.vp6",
            OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.vp6", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.vp8",
           OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.vp8", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.vp9",
         OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.vp9", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.avc", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.avc",
             OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.avc", OMX_MAX_STRINGNAME_SIZE))
    ...
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.hevc", OMX_MAX_STRINGNAME_SIZE))
        {
            loge("Setparameter: unknown Index %s\n", srcRole);
            return OMX_ErrorUnsupportedSetting;
        }
    ...
    else if(!strncmp((char*)impl->m_cName, "OMX.allwinner.video.decoder.hevc",
             OMX_MAX_STRINGNAME_SIZE))
    {
        if(srcRole != NULL &&
        strncmp((const char*)srcRole,"video_decoder.hevc", OMX_MAX_STRINGNAME_SIZE))
...
static void doSubmit(AwOmxVdec *impl)
{
    ...
    {
        int ret = OmxVdecoderSubmit(impl->pDec, pInBufHdr);
        if(ret != 0)
        {
...
static OMX_ERRORTYPE __AwOmxVdecInit(OMX_HANDLETYPE hComponent, OMX_STRING pComponentName)
{
    ...
    OMX_ERRORTYPE err = omxSetRole(impl, NULL);
                                                ...
                                                OMX_IN OMX_BUFFERHEADERTYPE* pBufferHdr)
{
    ...
    if (pBufferHdr->nInputPortIndex != kInputPortIndex ||
        pBufferHdr->nOutputPortIndex != kInvalidPortIndex)
        return OMX_ErrorBadPortIndex;
                                          ...
                                          OMX_IN OMX_BUFFERHEADERTYPE* pBufferHdr)
{
    ...
    if (pBufferHdr->nOutputPortIndex != kOutputPortIndex ||
        pBufferHdr->nInputPortIndex != kInvalidPortIndex)
        return OMX_ErrorBadPortIndex;
