...
#include <arch/cpu.h>
	...
	defined(CONFIG_ARCH_SUN50IW9) || defined(CONFIG_ARCH_SUN8IW15) ||	\
...
#define SMC_SPECULATION_CTRL_REG      (SUNXI_SMC_BASE + 0x0030)
#define SMC_DRAM_EN_REG               (SUNXI_SMC_BASE + 0x0038)

#define SMC_GPU_EN_REG		      (SUNXI_SMC_BASE + 0x0054)
#define SMC_DRAM_ILLEGAL_ACCESS0_REG  (SUNXI_SMC_BASE + 0x0058)

#define SMC_LOW_SADDR_REG             (SUNXI_SMC_BASE + 0x0060)
#define SMC_LOW_EADDR_REG             (SUNXI_SMC_BASE + 0x0064)
#define SMC_BITMAP_LOW_SADDR_REG      (SUNXI_SMC_BASE + 0x0068)
#define SMC_BITMAP_LOW_EADDR_REG      (SUNXI_SMC_BASE + 0x006c)
...
#define SMC_BMR_SRAM		      (SUNXI_SMC_BASE + 0x1000)
#define SMC_BMR_SRAM_SIZE	      (0x8000)
